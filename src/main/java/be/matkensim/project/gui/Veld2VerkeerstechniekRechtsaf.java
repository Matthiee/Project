...
public class Veld2VerkeerstechniekRechtsaf extends VBox implements View{
    ...
    private Label titel = new Label("Rechts afslaan");
    private ImageView titelAfb = new ImageView("resource/Verkeerstechniek/rechtsafNeutraal.png");
