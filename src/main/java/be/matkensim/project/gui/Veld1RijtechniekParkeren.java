...
public class Veld1RijtechniekParkeren extends VBox implements View{
    ...
    private Label titel = new Label("Parkeren");
    private ImageView titelAfb = new ImageView("resource/Rijtechniek/parkerenNeutraal.png");
    ...
    public Veld1RijtechniekParkeren(SchermController schermCtrl, EvaController evaCtrl, LeerlingController llnCtrl) {
        ...
        exit.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent e) {
                evaController.saveListDataRijtechniek("Parkeren", data);
                Veld1RijtechniekParkeren.this.schermController.setScherm(MainApp.RIJTECHNIEK_ID);
            }
        });
    ...
    @Override
    public void update(){
        data = evaController.loadListDataRijtechniek("Parkeren");
        table.setItems(data);
    }
