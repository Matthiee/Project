...
public class Veld2VerkeerstechniekLinksaf extends Pane implements View{
    ...
    private Label titel = new Label("Linksaf");
    private ImageView titelAfb = new ImageView("resource/Verkeerstechniek/linksafNeutraal.png");
    ...
    public Veld2VerkeerstechniekLinksaf(SchermController schermCtrl, EvaController evaCtrl, LeerlingController llnCtrl) {
        evaController = evaCtrl;
        schermController = schermCtrl;
        llnController = llnCtrl;
        this.llnController.getLeerling().addView(this);
        vBox1.getChildren().addAll(toon);
        houdingen.addAll("Linksaf", "Opstelling", "Uitvoering");
        ...
        exit.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent e) {
                evaController.saveListDataVerkeerstechniek("Linksaf", data);
                Veld2VerkeerstechniekLinksaf.this.schermController.setScherm(MainApp.VERKEERSTECHNIEK_ID);
            }
        });
    ...
    @Override
    public void update() {
        data = evaController.loadListDataVerkeerstechniek("Linksaf");
        table.setItems(data);
    }
