...
public class Veld2VerkeerstechniekPlaats extends Pane implements View{
    ...
    private Label titel = new Label("Openbare Weg");
    private ImageView titelAfb = new ImageView("resource/Verkeerstechniek/openbareWegNeutraal.png");
    ...
    public Veld2VerkeerstechniekPlaats(SchermController schermCtrl, EvaController evaCtrl, LeerlingController llnCtrl) {
        evaController = evaCtrl;
        schermController = schermCtrl;
        llnController = llnCtrl;
        this.llnController.getLeerling().addView(this);
        vBox1.getChildren().addAll(toon);
        houdingen.addAll("Plaats op de openbare weg", "Voorsorteren");
        ...
        exit.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent e) {
                evaController.saveListDataVerkeerstechniek("Plaats", data);
                Veld2VerkeerstechniekPlaats.this.schermController.setScherm(MainApp.VERKEERSTECHNIEK_ID);
            }
        });
    ...
    @Override
    public void update() {
        data = evaController.loadListDataVerkeerstechniek("Plaats");
        table.setItems(data);
    }
