...
public class Veld2VerkeerstechniekSnelheid extends VBox implements View{
    ...
    private Label titel = new Label("Snelheid");
    private ImageView titelAfb = new ImageView("resource/Verkeerstechniek/snelheidNeutraal.png");
