...
public class Veld2VerkeerstechniekAfstand extends VBox implements View{
    ...
    private Label titel = new Label("Afstand");
    private ImageView titelAfb = new ImageView("resource/Verkeerstechniek/afstandNeutraal.png");
