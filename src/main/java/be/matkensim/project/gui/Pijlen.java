...
public class Pijlen extends GridPane {
    ...
    public Pijlen(EvaController evaCtrl, int size) {
    ...
    public void update() {
        ...
        //stuur1
        if (pijl[0] == 0) {
            pijl1.setImage(pijl1Neutraal);
        }
        if (pijl[0] == 1) {
            pijl1.setImage(pijl1Groen);
        }
        if (pijl[0] == 2) {
            pijl1.setImage(pijl1Oranje);
        }
        if (pijl[0] == 3) {
            pijl1.setImage(pijl1Rood);
        }
        //stuur2
        if (pijl[1] == 0) {
            pijl2.setImage(pijl2Neutraal);
        }
        if (pijl[1] == 1) {
            pijl2.setImage(pijl2Groen);
        }
        if (pijl[1] == 2) {
            pijl2.setImage(pijl2Oranje);
        }
        if (pijl[1] == 3) {
            pijl2.setImage(pijl2Rood);
        }
        //stuur3
        if (pijl[2] == 0) {
            pijl3.setImage(pijl3Neutraal);
        }
        if (pijl[2] == 1) {
            pijl3.setImage(pijl3Groen);
        }
        if (pijl[2] == 2) {
            pijl3.setImage(pijl3Oranje);
        }
        if (pijl[2] == 3) {
            pijl3.setImage(pijl3Rood);
        }
    }
}
