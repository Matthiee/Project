...
public class Veld1RijtechniekSchakeltechniek extends VBox implements View{
    ...
    private Label titel = new Label("Schakeltechniek");
    private ImageView titelAfb = new ImageView("resource/Rijtechniek/schakelNeutraal.png");
