...
public class Veld1RijtechniekHouding extends VBox implements View{
    ...
    private Label titel = new Label("Houding");
    private ImageView titelAfb = new ImageView("resource/Rijtechniek/houdingNeutraal.png");
