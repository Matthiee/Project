...
public class Veld2VerkeerstechniekKruisen extends VBox implements View{
    ...
    private Label titel = new Label("Kruisen");
    private ImageView titelAfb = new ImageView("resource/Verkeerstechniek/kruisenNeutraal.png");
    ...
    public Veld2VerkeerstechniekKruisen(SchermController schermCtrl, EvaController evaCtrl, LeerlingController llnCtrl) {
        ...
        toon.setMinHeight(500);
        toon.setMaxHeight(500);
