...
public class Veld2VerkeerstechniekInhalen extends VBox implements View{
    ...
    private Label titel = new Label("Inhalen");
    private ImageView titelAfb = new ImageView("resource/Verkeerstechniek/inhalenNeutraal.png");
    ...
    public Veld2VerkeerstechniekInhalen(SchermController schermCtrl, EvaController evaCtrl, LeerlingController llnCtrl) {
        ...
        exit.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent e) {
                evaController.saveListDataVerkeerstechniek("Inhalen", data);
    ...
    @Override
    public void update() {
        data = evaController.loadListDataVerkeerstechniek("Inhalen");
        table.setItems(data);
    }
