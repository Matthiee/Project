...
public class Veld1RijtechniekHelling extends VBox implements View{
    ...
    private Label titel = new Label("Helling");
    private ImageView titelAfb = new ImageView("resource/Rijtechniek/hellingNeutraal.png");
