...
public class Veld2VerkeerstechniekPlaats extends Pane {
    ...
    private ObservableList<Verkeerstechniek> data
            = FXCollections.observableArrayList(
                    new Verkeerstechniek("Plaats op de openbare weg", ""),
                    new Verkeerstechniek("Voorsorteren", "")
            );

    public Veld2VerkeerstechniekPlaats(SchermController schermCtrl) {
