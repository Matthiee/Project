 ...
 * @author Kenzo
 */
public class Veld2VerkeerstechniekAfstand extends Pane {
    ...
    private ObservableList<Verkeerstechniek> data
            = FXCollections.observableArrayList(
                    new Verkeerstechniek("Volgafstand", ""),
                    new Verkeerstechniek("Zijdelingse afstand", "")
            );

    public Veld2VerkeerstechniekAfstand(SchermController schermCtrl) {
