...
public class Onderdeel extends ImageView {
    ...
    public Onderdeel(String neutraal, String gekend, String gezien_niet_gekend, String niet_gekend){
        super(neutraal);
    ...
    /**
     * Zet de afbeelding in de ImageView.
     * De afbeeldingen worden gecached om laadtijden te verlagen en voor optimalisatie.
